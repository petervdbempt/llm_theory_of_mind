...
- files_and_progression
  - Here you can find some files with visualisations of the work we have done alongside documentation of how we progressed 
  through the project and what our findings and suggestions for future research are. 
- utils 
...
![seed14gamestateplot.png](files_and_progression/seed14gamestateplot.png)
